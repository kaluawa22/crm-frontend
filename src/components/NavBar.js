    ...
    <header className="w-full bg-gray-200 text-gray-500 body-font mb-4 shadow-sm">
      ...
      <div className="container mx-auto flex justify-between items-center py-7 px-5">
        ...
        <a href={`/`} className="flex flex-shrink-0 title-font font-medium items-center text-gray-900 md:mb-0">
          ...
          <span className="ml-3 text-xl font-semibold antialiased">Customer Relations Management</span>
        </a>
        {/* Navbar */}
        <nav className="hidden md:ml-auto md:flex flex-wrap items-center justify-center text-base tracking-wide">
          <a href="#link" className="mr-8 hover:text-gray-300">New Agent</a>
          <a href={`/newlead/`} className="mr-8 hover:text-gray-300" >New Lead</a>
